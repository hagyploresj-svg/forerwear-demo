  ...
  return (
    <footer className="border-t border-stone/70 bg-ink text-bone">
      <div className="mx-auto grid max-w-content gap-10 px-5 py-14 md:grid-cols-4 md:px-8">
        <div>
          <p className="font-display text-xl font-black tracking-tightest">
            SHNWear<span className="text-stone">MEN</span>
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5">
            <li>
              <Link href="/siparis-teslimat" className="text-sm text-bone/80 hover:text-bone">
                Sipariş &amp; Teslimat
              </Link>
            </li>
            <li>
              <Link href="/degisim-iade" className="text-sm text-bone/80 hover:text-bone">
                Değişim / İade
              </Link>
            </li>
            <li>
              <Link href="/iletisim" className="text-sm text-bone/80 hover:text-bone">
                İletişim
              </Link>
            </li>
          </ul>
      ...
      <div className="border-t border-bone/10 px-5 py-5 text-center text-xs text-bone/40 md:px-8">
        © {new Date().getFullYear()} SHNWearMEN. Tüm hakları saklıdır.
      </div>
    </footer>
  );
}
